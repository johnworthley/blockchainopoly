...
function updatePosition() {
	...
	for (var i = 0; i < 40; i++) {
		document.getElementById("cell" + i).style.border = "1px solid gray";
		document.getElementById("cell" + i).style.fontSize = "12px";
		document.getElementById("cell" + i + "positionholder").innerHTML = "";
	}
	document.getElementById("cell1").style.borderTop = "30px solid SaddleBrown";
	document.getElementById("cell2").style.paddingTop = "30px";
	document.getElementById("cell3").style.borderTop = "30px solid SaddleBrown";
	document.getElementById("cell6").style.borderTop = "30px solid SkyBlue";
	document.getElementById("cell8").style.borderTop = "30px solid SkyBlue";
	document.getElementById("cell9").style.borderTop = "30px solid SkyBlue";
	document.getElementById("cell11").style.borderRight = "30px solid DarkOrchid";
	document.getElementById("cell12").style.paddingRight = "30px";
	document.getElementById("cell13").style.borderRight = "30px solid DarkOrchid";
	document.getElementById("cell14").style.borderRight = "30px solid DarkOrchid";
	document.getElementById("cell15").style.paddingRight = "30px";
	document.getElementById("cell16").style.borderRight = "30px solid Orange";
	document.getElementById("cell17").style.paddingRight = "30px";
	document.getElementById("cell18").style.borderRight = "30px solid Orange";
	document.getElementById("cell19").style.borderRight = "30px solid Orange";
	document.getElementById("cell21").style.borderBottom = "30px solid Red";
	document.getElementById("cell22").style.paddingBottom = "30px";
	document.getElementById("cell23").style.borderBottom = "30px solid Red";
	document.getElementById("cell24").style.borderBottom = "30px solid Red";
	document.getElementById("cell25").style.paddingBottom = "30px";
	document.getElementById("cell26").style.borderBottom = "30px solid Yellow";
	document.getElementById("cell27").style.borderBottom = "30px solid Yellow";
	document.getElementById("cell28").style.paddingBottom = "30px";
	document.getElementById("cell29").style.borderBottom = "30px solid Yellow";
	document.getElementById("cell31").style.borderLeft = "30px solid Green";
	document.getElementById("cell32").style.borderLeft = "30px solid Green";
	document.getElementById("cell33").style.paddingLeft = "30px";
	document.getElementById("cell34").style.borderLeft = "30px solid Green";
	document.getElementById("cell35").style.paddingLeft = "30px";
	document.getElementById("cell36").style.paddingLeft = "30px";
	document.getElementById("cell37").style.borderLeft = "30px solid Blue";
	document.getElementById("cell38").style.paddingLeft = "30px";
	document.getElementById("cell39").style.borderLeft = "30px solid Blue";
...
function play() {
	...
	$("#board, #control, #moneybar, #viewstats, #buy, #title").show();
